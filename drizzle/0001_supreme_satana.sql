...
ALTER TABLE "accounts" ADD COLUMN "yapily_account_id" text;--> statement-breakpoint
ALTER TABLE "accounts" ADD COLUMN "yapily_consent_token" text;--> statement-breakpoint
